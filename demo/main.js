requirejs.config({
  ...
  waitSeconds : 0,
    paths: {
        "skylark-threejs-editor-all" :  "../dist/uncompressed/skylark-threejs-editor-all"
    },
      packages: [
         {
...
//           location : "../../../domx/skylark-domx-files/src",
          ...
          },
         {
          ...
          {
            name: 'skylark-jszip',
            location : "../node_modules/skylark-jszip/dist/uncompressed/skylark-jszip",
            main: 'main'
          },
          {
            name: 'skylark-data-color',
            location : "../node_modules/skylark-data-color/dist/uncompressed/skylark-data-color",
            main: 'main'
          },
          {
            name: 'skylark-datgui',
            location : "../node_modules/skylark-datgui/dist/uncompressed/skylark-datgui",
            main: 'main'
          },

          {
            name: 'skylark-threegltfviewer',
            location : "../src",
            main: 'main'
          }                   
        ]
...
//require(["skylark-threegltfviewer-all"],function() {
  require(["skylark-domx-query"], function ($) {
      require(["skylark-threegltfviewer"], function (threegltfviewer) {
          if (window.initPage) {
              window.initPage($,threegltfviewer);
          }
      });
  });
//});
